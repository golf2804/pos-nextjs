  ...
  return (
    <main className="grid min-h-screen bg-slate-100 text-slate-950 lg:grid-cols-[minmax(380px,0.86fr)_minmax(540px,1.14fr)]">
      <section className="hidden border-r border-slate-800 bg-slate-950 p-10 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="flex animate-fade-in-left items-center gap-3">
        ...
        <div className="max-w-md animate-fade-in-left" style={{ animationDelay: "80ms" }}>
      ...
      <section className="flex items-center justify-center px-5 py-12 sm:px-8">
        <div className="w-full max-w-md animate-soft-rise rounded-lg border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
